...
pub fn nbx_genesis(
	...
	GenesisConfig {
		...
		pallet_balances: BalancesConfig {
			// Configure endowed accounts with initial balance of 1 << 60 1_152_921_504_606_847_000.
			balances: endowed_accounts.iter().cloned().map(|k|(k, 8888000000000000000000)).collect(),
		},
