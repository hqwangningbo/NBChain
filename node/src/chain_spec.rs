use nbchain_runtime::{pallet_kitties::Gender, BlockNumber};
pub use nbchain_runtime::{
    AccountId, AuraConfig, BalancesConfig, EthereumChainIdConfig, GenesisConfig, GrandpaConfig,
    KittiesConfig, Signature, SudoConfig, SystemConfig, WASM_BINARY, VestingConfig,
    EvmConfig, EthereumConfig, GenesisAccount,
};
