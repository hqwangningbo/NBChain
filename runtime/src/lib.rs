...
use frame_support::{pallet_prelude::ConstU32, traits::Get, weights::IdentityFee};
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		OffchainWorker: pallet_template::{Pallet, Call, Storage, Event<T>},
	}
);
